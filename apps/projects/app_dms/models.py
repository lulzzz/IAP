...
class StrategicSalesPlan(models.Model, mixins_model.ModelFormFieldNames):
    ...
    gross_sales_init = models.FloatField(blank=True, null=True)
    ...
    average_cost_of_inventory = models.FloatField(blank=True, null=True)
    intake_beginning_of_season = models.FloatField(blank=True, null=True)
